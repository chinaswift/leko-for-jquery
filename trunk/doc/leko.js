...
o=this,d=o.data(n);if(!d)o.data(n,d=eval("({"+(o.attr(n)||"")+"})"));return d;},visible:function(){with(this)return{d:css("display")!="none",v:css("visibility")!="hidden"};},transparent:function(b){return this.css({visibility:b?"hidden":"visible"});},layout:function(o,w,h){o=$(o);return this.resizeTo(w===0?"":o.outerWidth()+(w||0),h===0?"":o.outerHeight()+(h||0),1);},bubble:function(){}});$.each(["To","By"],function(i,v){$.fn["move"+v]=function(x,y){var
