...
if(x.length)$(_.unique(x).join(",")).live(t,function(){$(this).toggleClass(p);});},html5Tag:function(){if(_.msie(9,1)){$.each("article,aside,audio,canvas,datalist,details,eventsource,figure,footer,header,hgroup,mark,meter,nav,output,progress,section,time,video".split(','),function(i,v){document.createElement(v);});}}},b=$.browser,s=$.support;$.fn.conf=function(n){var
o=this,d=o.data(n);if(!d)o.data(n,d=eval("({"+(o.attr(n)||"")+"})"));return d;}
$.each(["webkit","opera","msie","mozilla"],function(i,v){_[v]=function(n,m){return!!(b[v]&&_.ver(b.version,n)!=(m||0));}});window.Leko=window._=_;_.html5Tag();s.rgba=_.msie(9)||_.mozilla(1.9)||_.webkit(525)||_.opera(10);b=_.msie(9)&&1||_.mozilla("1.9.1")&&2||_.webkit(522)&&3||_.opera(10.5)&&1;s.shadow=b&&["b","MozB","WebkitB"][b-1]+"oxShadow";})(window,window.document,jQuery);