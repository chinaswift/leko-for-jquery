...
b=o.visible(),f=o.css("position"),t=f=="static",l=f=="relative";if(!b.d)o.transparent(1).show();e.css({position:t||l?"absolute":f}).layout(o).locate(o,1,1,x-r+(!r||!x?0:x>0?-1:1),y-r+(!r||!x?0:y>0?-1:1)).bubble(o,1,1).add(o).transparent(!b.v).toggle(b.d);};d._();}},{x:2,y:2,blur:3,color:[0,0,0,0.3]});})(Leko,jQuery);