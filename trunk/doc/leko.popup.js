...
o.transparent();q=o[$c]();e.height(o.outerHeight()).width(o.outerWidth()).css({top:q.top+y-r+(y>0?-1:y<0?1:0)+"px",left:q.left+x-r+(x>0?-1:x<0?1:0)+"px",zIndex:o.css("zIndex"),opacity:a,background:"#000",filter:s?"progid:DXImageTransform.Microsoft.blur(pixelradius="+r+",makeshadow='true',ShadowOpacity="+a+")":""}).transparent(!b.v).toggle(b.d&&n).insertBefore(o);}},{x:2,y:2,blur:3,opacity:0.3});$.fn.bubble=(function(){var
i=0;return function(){return i++;}})();$.fn.extend({addShadow:function(){return this.each(function(){var
o=$(this),d=o.data("shadow");});}});})(Leko,jQuery);