...
n=s[0];e=$(k,o).addClass(n);x();e.removeClass(n);});w(v[q]);o[e]();},{inner:{},speed:1000,fx:"outback"},{lava:function(o,e,v,d,r,h,s){if(h){var
a="position",p=e.css(a,function(i,v){return v=="static"?"relative":v;})[a]();(d.b=d.b||$("<li />").addClass("deco").append("<a href='#'>&nbsp;</a>").css({float:"none",position:"absolute"}).height(e.height()).prependTo(o).moveTo(NaN,p.top)).stop().animate($.extend({left:p.left,width:(v.inner.w?$("a",e):e).width()},v.lava),v.speed,v.fx);}},lamp:function(o,e,v,d,r,h,s){$("a",e).stop().play((v.allwaysShowSelect?h||s:h)?v.lamp:null,v.speed,v.fx);},lade:function(o,e,v,d,r,h,s){e.css("position",function(i,v){return v=="static"?"relative":v;});(r.b=r.b||($("<li />").addClass("deco").append("<a href='#'>&nbsp;</a>").css({float:"none",position:"absolute"}).resize(e,0,2).prependTo(o).move(e,1,1))).stop().play((v.allwaysShowSelect?h||s:h)?v.lade:null,v.speed,v.fx);}});})(Leko,jQuery);