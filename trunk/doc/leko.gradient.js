...
b.$=q;}
o.stop().animate(t?q:g,w.speed,w.fx,t?function(){for(var i in b._)o.css(i,b._[i]);}:void 0);}};if(l)o.undelegate(l,m,d[m]).delegate(l,m,d[m]=f);else o.unbind(m,d[m]).bind(m,d[m]=f);},{fx:"swing",speed:1000});})(Leko,jQuery);