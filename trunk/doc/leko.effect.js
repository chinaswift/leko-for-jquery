...
else s=p/(2*I)*N(c/a);return t<1?-.5*(a*W(2,10*(t-=1))*S((t*d-s)*(2*I)/p))+b:a*W(2,-10*(t-=1))*S((t*d-s)*(2*I)/p)*.5+c+b;case 24:return c*(t/=d)*t*((s+1)*t-s)+b;case 25:return c*((t=t/d-1)*t*((s+1)*t+s)+1)+b;case 26:return(t/=d/2)<1?c/2*(t*t*(((s*=(1.525))+1)*t-s))+b:c/2*((t-=2)*t*(((s*=(1.525))+1)*t+s)+2)+b;case 27:return c-e.outbounce(x,d-t,0,c,d)+b;case 28:return(t/=d)<(1/2.75)?c*(7.5625*t*t)+b:t<(2/2.75)?c*(7.5625*(t-=(1.5/2.75))*t+.75)+b:t<(2.5/2.75)?c*(7.5625*(t-=(2.25/2.75))*t+.9375)+b:c*(7.5625*(t-=(2.625/2.75))*t+.984375)+b;case 29:return t<d/2?e.inbounce(x,t*2,0,c,d)*.5+b:e.outbounce(x,t*2-d,0,c,d)*.5+c*.5+b;}}};$.each(["inquad","outquad","inoutquad","incubic","outcubic","inoutcubic","inquart","outquart","inoutquart","inquint","outquint","inoutquint","insine","outsine","inoutsine","inexpo","outexpo","inoutexpo","incirc","outcirc","inoutcirc","inelastic","outelastic","inoutelastic","inback","outback","inoutback","inbounce","outbounce","inoutbounce"],function(i,v){e[v]=f(i);});})(Leko,jQuery);