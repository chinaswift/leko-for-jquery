...
o=$(this),n=l.fn,d=o.leko(n);return f(o,$.extend(true,{},$.leko[n],l.arguments[0],d),d,n)!==false;});}})(a[m+1]);f.fn=n;$.fn[n]=f;$.leko[n]=$.extend({enabled:1},a[m+2]);}},pseudoClass:function(){var
...
d=$b.msie&&$(this).data("shadow");return d&&d.$?d:{};},andShadow:function(){with(this)return add(getShadow().$);},transparent:function(b){return this.css({visibility:b?"hidden":"visible"});}});$.each(["To","By"],function(i,v){$.fn["move"+v]=function(x,y){var
m=$.isNumber(x),n=$.isNumber(y);return this.each(function(z,o){o=$(o);z=o.position();if(m)o.css({left:(i?z.left+x:x)+"px"});if(n)o.css({top:(i?z.top+y:y)+"px"});});};$.fn["resize"+v]=function(w,h,b){var
m=$.isNumber(w),n=$.isNumber(h);return this.each(function(z,o){o=$(o);if(m)o.width(function(n,x){return i?w+x:b?w+x-o.outerWidth():w;});if(h)o.height(function(n,x){return i?h+x:b?h+x-o.outerHeight():h;});});};});$.fn.bubble=(function(){var
i=0;return function(){return i++;}})();window.Leko=window._=_;_.html5Tag();})(window,window.document,jQuery);