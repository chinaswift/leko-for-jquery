...
o=this,d=o.data(n);if(!d)o.data(n,d=eval("({"+(o.attr(n)||"")+"})"));return d;},visible:function(){with(this)return{d:css("display")!="none",v:css("visibility")!="hidden"};},transparent:function(b){return this.css({visibility:b?"hidden":"visible"});}});})(window,window.document,jQuery);