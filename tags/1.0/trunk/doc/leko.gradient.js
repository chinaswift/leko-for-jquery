...
o=$(this),b=l?o.runtimes(n):d,w=l?o.currents(n,$.extend(true,{},v,o.defaults(n))):v,t=/(?:t|e)$/.test(e.type),g=w.css,q=b.$,p=_.constants.colorProps,j=g[p[2]],i=3;if(!q){delete g[p[2]];if(j)while(i<7)g[p[i++]]=j;q={};b._={};for(i in g){b._[i]=o.css(i);q[i]=_.solidColor(this,i);}
b.$=q;}
