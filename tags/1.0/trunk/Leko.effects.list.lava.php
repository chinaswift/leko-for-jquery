...
#list1{border:1px solid #dfdfdf;padding:15px;width:550px;}
#list1 li a{font-size:14px;font-weight:bold;letter-spacing:1px;padding:5px 15px;color:#333;}
#list1 li.deco{background:#ccc;}
...
#list4 li.deco{background:#ccc;}

#list5{border:1px solid #dfdfdf;padding:15px 30px;width:270px;}
#list5 li{display:block;height:30px;}
#list5 li a{height:30px;line-height:30px;color:#333;}
#list5 li.deco{border-bottom:4px solid #000;display:none;}
...
<ul id="list1" class="nav" list="effect:'lava',lava:{background:'#ccc'}">
<li><a href="#">新闻</a></li>
<li li="lava:{background:'#00B8EE'}"><a href="#">房地产</a></li>
<li li="lava:{background:'#EC108D'}"><a href="#">欧洲进口洁具</a></li>
<li class="checked" li="lava:{background:'#F8A530'}"><a href="#">美食</a></li>
...
<ol id="list4" class="nav" list="vertical:1,fx:'linear',speed:300,effect:'lava',lava:{background:'#ccc',color:'#000'}">
<li><a href="#">新闻</a></li>
<li li="lava:{background:'#00B8EE'}"><a href="#">房地产</a></li>
...
<ol id="list5" class="nav" list="effect:['lava','lamp'],vertical:1,fx:'inoutquart',speed:600,lava:{borderBottomColor:'#999'},lamp:{color:'#999'}">
<li><a href="#">新闻</a></li>
<li li="lamp:{color:'#00B8EE'},lava:{borderBottomColor:'#00B8EE'}"><a href="#">房地产</a></li>
<li li="lamp:{color:'#EC108D'},lava:{borderBottomColor:'#EC108D'}"><a href="#">欧洲进口洁具</a></li>
<li li="lamp:{color:'#F8A530'},lava:{borderBottomColor:'#F8A530'}"><a href="#">美食</a></li>
