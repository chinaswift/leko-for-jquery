(function(_,$){
	...
	var
		...
		b=$.support.rgba,
		p=['color','backgroundColor','borderColor','borderBottomColor','borderLeftColor','borderRightColor','borderTopColor','outlineColor'],
			...
			var
				...
				f=function(e){
					if(v.enabled){
						...
						o.stop(true).animate(b?q.$:g,w.duration,w.easing,function(){
							if(b){
								delete q.$;
